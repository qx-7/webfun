...
var $author$project$Weather$DataReceived = function (a) {
...
var $author$project$Weather$Weather = F4(
	function (time, temperature, humidity, weatherCode) {
		return {humidity: humidity, temperature: temperature, time: time, weatherCode: weatherCode};
	});
...
var $author$project$Weather$checkWeather = function (locationCoords) {
	var longitude = $elm$core$String$fromFloat(locationCoords.b);
	var latitude = $elm$core$String$fromFloat(locationCoords.a);
	return $elm$http$Http$get(
		{
			expect: A2(
				$elm$http$Http$expectJson,
				A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Weather$DataReceived),
				$author$project$Weather$weatherDecoder),
			url: 'https://api.open-meteo.com/v1/forecast?' + (('latitude=' + latitude) + (('&longitude=' + longitude) + '&current=temperature_2m,relative_humidity_2m,weather_code'))
		});
};
var $author$project$Weather$init = function (_v0) {
	return _Utils_Tuple2(
		{
			currentWeather: $krisajenkins$remotedata$RemoteData$Loading,
			locationCoords: _Utils_Tuple2(0, 0)
		},
		$author$project$Weather$checkWeather(
			_Utils_Tuple2(0, 0)));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Weather$newLocationCoords = F3(
	function (oldCoords, axisNumber, newCoord) {
		var oldLongitude = oldCoords.b;
		var oldLatitude = oldCoords.a;
		switch (axisNumber) {
			case 0:
				return _Utils_Tuple2(newCoord, oldLongitude);
			case 1:
				return _Utils_Tuple2(oldLatitude, newCoord);
			default:
				return oldCoords;
		}
	});
...
var $author$project$Weather$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'CheckWeather':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentWeather: $krisajenkins$remotedata$RemoteData$Loading}),
					$author$project$Weather$checkWeather(model.locationCoords));
			case 'UpdateLatitude':
				var latitude = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							locationCoords: A3($author$project$Weather$newLocationCoords, model.locationCoords, 0, latitude)
						}),
			...
			case 'UpdateLongitude':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							locationCoords: A3($author$project$Weather$newLocationCoords, model.locationCoords, 1, longitude)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DataReceived':
				var response = msg.a;
...
var $author$project$Weather$CheckWeather = {$: 'CheckWeather'};
...
var $author$project$Weather$extractCoordFromModel = F2(
	function (model, axisNumber) {
		switch (axisNumber) {
			case 0:
				return $elm$core$String$fromFloat(model.locationCoords.a);
			case 1:
				return $elm$core$String$fromFloat(model.locationCoords.b);
			default:
				return '0.0';
		}
	});
...
var $author$project$Weather$styledInput = A2(
...
var $author$project$Weather$UpdateLatitude = function (a) {
	return {$: 'UpdateLatitude', a: a};
};
var $author$project$Weather$UpdateLongitude = function (a) {
	return {$: 'UpdateLongitude', a: a};
};
var $author$project$Weather$floatFromString = function (string) {
	var result = A2($elm$json$Json$Decode$decodeString, $elm$json$Json$Decode$float, string);
	if (result.$ === 'Ok') {
		var _float = result.a;
...
var $author$project$Weather$updateAxis = F2(
	function (axisNumber, newCoordString) {
		var newCoordFloat = $author$project$Weather$floatFromString(newCoordString);
		if (newCoordFloat.$ === 'Just') {
			var _float = newCoordFloat.a;
			switch (axisNumber) {
				case 0:
					return $author$project$Weather$UpdateLatitude(_float);
				case 1:
					return $author$project$Weather$UpdateLongitude(_float);
				default:
					return $author$project$Weather$DoNothing;
			}
		} else {
			return $author$project$Weather$DoNothing;
		}
...
var $author$project$Weather$inputCoordinateFromModel = F2(
	function (model, axisNumber) {
		var axisName = function () {
			switch (axisNumber) {
				case 0:
					return 'latitude';
				case 1:
...
var $author$project$Weather$buildErrorMessage = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
...
var $author$project$Weather$viewError = function (errorMessage) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Couldn\'t get the weather!')
					])),
...
var $author$project$Weather$styledTable = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Weather$styledTh = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Weather$viewTableHeader = A2(
	$rtfeldman$elm_css$Html$Styled$tr,
	_List_Nil,
	_List_fromArray(
		[
			A2(
			$author$project$Weather$styledTh,
			_List_Nil,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Temperature')
				])),
			A2(
			$author$project$Weather$styledTh,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Relative Humidity')
				])),
			A2(
			$author$project$Weather$styledTh,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Weather Code')
				]))
		]));
var $rtfeldman$elm_css$Html$Styled$td = $rtfeldman$elm_css$Html$Styled$node('td');
var $author$project$Weather$styledTd = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Weather$viewWeatherDetails = function (weather) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$tr,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				$author$project$Weather$styledTd,
				_List_Nil,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(weather.time)
					])),
				A2(
				$author$project$Weather$styledTd,
				_List_Nil,
				_List_fromArray(
					[
						...
						$elm$core$String$fromFloat(weather.temperature))
					])),
				A2(
				$author$project$Weather$styledTd,
				_List_Nil,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						$elm$core$String$fromInt(weather.humidity))
					])),
				A2(
				$author$project$Weather$styledTd,
				_List_Nil,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						$elm$core$String$fromInt(weather.weatherCode))
					]))
			]));
};
var $author$project$Weather$viewWeather = function (weather) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Current Weather')
					])),
				A2(
				$author$project$Weather$styledTable,
				_List_Nil,
				_Utils_ap(
					_List_fromArray(
						[$author$project$Weather$viewTableHeader]),
					_List_fromArray(
						[
							$author$project$Weather$viewWeatherDetails(weather)
						])))
			]));
};
var $author$project$Weather$viewWeatherOrError = function (model) {
	var _v0 = model.currentWeather;
	switch (_v0.$) {
		case 'NotAsked':
		...
		case 'Success':
			var weather = _v0.a;
			return $author$project$Weather$viewWeather(weather);
		default:
			var httpError = _v0.a;
			return $author$project$Weather$viewError(
				$author$project$Weather$buildErrorMessage(httpError));
	}
};
var $author$project$Weather$view = function (model) {
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Pirate Weather v' + $author$project$Weather$pirateVersion)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$p,
					_List_Nil,
					...
					_List_fromArray(
						[
							...
							A2(
							$author$project$Weather$styledButton,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Weather$CheckWeather),
									$rtfeldman$elm_css$Html$Styled$Attributes$type_('button')
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('check weather')
								]))
						])),
					$author$project$Weather$viewWeatherOrError(model)
				])));
};
var $author$project$Weather$main = $elm$browser$Browser$element(
	{
		init: $author$project$Weather$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Weather$update,
		view: $author$project$Weather$view
	});
_Platform_export({'Weather':{'init':$author$project$Weather$main(
